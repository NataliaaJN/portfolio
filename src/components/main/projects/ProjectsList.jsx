...
const ProjectsList = () => {
  ...
  React.Children.toArray(projectsData.map((eachProject) => {
    console.log(eachProject.projectImg);
    return(
      <Project
        id={eachProject.id}
        projectImg={eachProject.projectImg}
        projectAlt={eachProject.projectAlt}
        projectName={eachProject.projectName}
        projectDescription={eachProject.projectDescription}
        projectDetail={eachProject.projectDetail}
        technologies={eachProject.technologies}
        linkWeb={eachProject.linkWeb}
        linkGithub= {eachProject.linkGithub}
      />)
  }));
